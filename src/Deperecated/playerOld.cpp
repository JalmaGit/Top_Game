...
std::shared_ptr<threepp::Mesh> PlayerOld::playerModelCreation() {
...
std::shared_ptr<threepp::PerspectiveCamera> PlayerOld::getCameraCreation(const threepp::Canvas &canvas) {
